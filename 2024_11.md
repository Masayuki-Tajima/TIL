...
11/28<br>
Udemy教材でDockerを学習（Dev Containersの環境構築、AWS ECRの設定）<br>

11/29<br>
Udemy教材でDockerを学習（AWS ECSの設定、GitHub Actionsの設定、ECSへのデプロイ、リソースの削除）<br>

11/30<br>
体調管理アプリを制作（要件定義、基本設計（画面設計、画面遷移図、ER図、業務フローの作成）、詳細設計（クラス図の作成））<br>